...
export class CardService {
	 ...
	 * @param {function} onSuccess - The callback function to be executed whe the balance update is successful.
	 ...
	 * @param {string} body.toCardNumber - The recepient's card number.
	 * @param {Function} onSuccess - The callback function to be executed upon successful transfer.
	 * @return {Promise} A promise that resolves with the redQuery
	 */
